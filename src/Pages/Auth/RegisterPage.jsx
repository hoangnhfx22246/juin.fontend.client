...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const registerPromise = dispatch(registerUser(formData)).unwrap(); // unwrap để lấy giá trị trả về từ thunk
    showNotification.promise(registerPromise, {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
                placeholder="Điền lại mật khẩu giống trên"
